      ...
      <div className="max-w-7xl mx-auto px-5">
        ...
        >
          ...
          <p className="mt-5 max-w-2xl mx-auto text-lg text-slate-500 leading-8">
            Join thousands of happy customers who trust Urban Kicks for premium
        ...
        >
          ...
          >
            {[...displayReviews].map((review, index) => (
              <div className="group relative h-[390px] w-[280px] flex-shrink-0 overflow-hidden rounded-3xl bg-slate-200 shadow-lg transition-transform duration-300 hover:-translate-y-2">
                {/* Image */}
                ...
                <div className="absolute bottom-0 w-full bg-black/35 backdrop-blur-md p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-white/70">{review.city}</p>
                    </div>
